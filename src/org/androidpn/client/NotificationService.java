...
public class NotificationService extends Service {
	...
	private Intent myintent = new Intent("com.example.communication.RECEIVER");
	...
	public void disconnect() {
		...
		if (Commonutil.isNetworkAvailable(NotificationService.this)) {

			MessageUtil.commonToast(NotificationService.this, "服务器连接异常",
					Toast.LENGTH_SHORT);
		}
		taskSubmitter.submit(new Runnable() {
			public void run() {
