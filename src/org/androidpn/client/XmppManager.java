...
public class XmppManager {
	...
	public XmppManager(NotificationService notificationService) {
		...
		MessageUtil.commonToast(context, "正在连接服务器 请稍后", Toast.LENGTH_SHORT);
		handler1 = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case 11:
					MessageUtil
							.commonToast(context, "连接成功", Toast.LENGTH_SHORT);
					break;

				case 12:
					if (Commonutil.isNetworkAvailable(context)) {
						MessageUtil.commonToast(context, "正在连接服务器 请稍后",
								Toast.LENGTH_SHORT);
					}
	...
	private String newRandomUUID() {
		String user = XZHL0001_LoginInfo.SHOPID + XZHL0001_LoginInfo.USERNAME
				+ deviceId;
		// String user = XZHL0001_LoginInfo.SHOPID+XZHL0001_LoginInfo.MARKING;
		Log.i("UserName", "$$$$$$$$$$$$" + user);
		return user;
	}
	...
	private class RegisterTask implements Runnable {
		...
		public void run() {
			...
			if (!xmppManager.isRegistered()) {
				...
				final String newPassword = newUsername;
			...
			if (!xmppManager.isAuthenticated()) {
				...
				try {
					xmppManager.getConnection().login(
							xmppManager.newRandomUUID(),
							xmppManager.newRandomUUID(), XMPP_RESOURCE_NAME);
