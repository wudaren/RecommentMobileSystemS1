...
public class XZHL0710_Adapter extends BaseAdapter{
LayoutInflater inflater;
List<XZHL0710_Bean> list;
	public XZHL0710_Adapter(Context context,List<XZHL0710_Bean> list,ListView listView){
	...
	@Override
	public XZHL0710_Bean getItem(int position) {
		// TODO Auto-generated method stub
