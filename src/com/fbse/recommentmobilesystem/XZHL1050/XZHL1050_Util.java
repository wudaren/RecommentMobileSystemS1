/*  XZHL1050_Util.java V01L01 Copyright＠QINGDAO FUBO SYSTEM ENGINEERING CO.,LTD 2012                                 */
/*--------------------------------------------------------------------------------------------------------------------*/
/*                                                                                                                    */
/*  项目名称 ：信智互联                                                                                               */
/*  画面ＩＤ ：XZHL1050                                                                                               */
...
/*  变更历史                                                                                                          */
/*      NO  日付                       Ver             更新者                 内容                                    */
/*      1   2014/05/23   V01L01      FBSE)尹小超      新規作成                                                        */
/*                                                                                                                    */
/*--------------------------------------------------------------------------------------------------------------------*/
...
/**
 * 商城产品广告一览工具类
 * 商城产品广告一览工具类,解析json字符串
 */
public class XZHL1050_Util {
     ...
     * @return 解析后的广告集合
     */
    public static List<XZHL1050_Bean> jsonToList(String str) {

        // Log开始
        LogUtil.logStart();
        List<XZHL1050_Bean> list = new ArrayList<XZHL1050_Bean>();
        try {
            ...
            if (success.equals(CommonConst.ONE)) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    XZHL1050_Bean bean = new XZHL1050_Bean();
