package com.fbse.recommentmobilesystem.XZHL1320;
...
public class XZHL1320_MsgdetailActivity extends Activity {
   private Button bt1;
   ...
   ArrayList<String> intents;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xzhl1320_msgdetail);
	   ...
	   tx1.setText(intents.get(1));
	 tx2.setText(intents.get(0));
	 addListener();
	}
	private void addListener() {
		bt1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					XZHL1320_MsgdetailActivity.this.finish();
				}
			});
	}
	@Override
