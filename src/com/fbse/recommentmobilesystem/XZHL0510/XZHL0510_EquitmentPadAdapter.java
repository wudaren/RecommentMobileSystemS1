...
public class XZHL0510_EquitmentPadAdapter extends BaseAdapter {
	...
	public XZHL0510_EquitmentPadAdapter(List<XZHL0510_DeviceArray> list,
	...
	public View getView(int arg0, View arg1, final ViewGroup arg2) {
		if (arg1 == null) {
			arg1 = View.inflate(context,
					R.layout.xzhl0510_equipmentlist_pad_item, null);
		}
		viewHolder = new ViewHolder();
		viewHolder.sequence = (TextView) arg1.findViewById(R.id.sequence3);
		viewHolder.sequence.setText(new DecimalFormat("000").format(arg0+1)+"");
		viewHolder.pepairstreet = (TextView) arg1.findViewById(R.id.pepairstreet3);
		viewHolder.pepairstreet.setText(list.get(arg0).getName());
		viewHolder.pepairnum = (TextView) arg1.findViewById(R.id.pepairnum3);
		viewHolder.pepairnum.setText(list.get(arg0).getOrgin_serial());
		viewHolder.pepairDate = (TextView) arg1.findViewById(R.id.pepairDate3);
		...
		viewHolder.stateRepair = (TextView) arg1.findViewById(R.id.stateRepair3);
		...
		viewHolder.historyquery = (TextView) arg1.findViewById(R.id.historyquery3);
