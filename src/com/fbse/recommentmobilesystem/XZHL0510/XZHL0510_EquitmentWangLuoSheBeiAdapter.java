...
public class XZHL0510_EquitmentWangLuoSheBeiAdapter extends BaseAdapter {
	...
	public XZHL0510_EquitmentWangLuoSheBeiAdapter(List<XZHL0510_DeviceArray> list,
	...
	public View getView(int arg0, View arg1, final ViewGroup arg2) {
		if (arg1 == null) {
			arg1 = View.inflate(context,
					R.layout.xzhl0510_equipmentlist_wangluoshebei_item, null);
		}
		viewHolder = new ViewHolder();
		viewHolder.sequence = (TextView) arg1.findViewById(R.id.sequence5);
		viewHolder.sequence.setText(new DecimalFormat("000").format(arg0+1)+"");
		viewHolder.pepairstreet = (TextView) arg1.findViewById(R.id.pepairstreet5);
		viewHolder.pepairstreet.setText(list.get(arg0).getName());
		viewHolder.pepairnum = (TextView) arg1.findViewById(R.id.pepairnum5);
		viewHolder.pepairnum.setText(list.get(arg0).getOrgin_serial());
		viewHolder.pepairDate = (TextView) arg1.findViewById(R.id.pepairDate5);
		...
		viewHolder.stateRepair = (TextView) arg1.findViewById(R.id.stateRepair5);
		...
		viewHolder.historyquery = (TextView) arg1.findViewById(R.id.historyquery5);
