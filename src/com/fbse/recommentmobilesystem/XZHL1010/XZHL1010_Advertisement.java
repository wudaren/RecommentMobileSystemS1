/*  XZHL1010_Advertisement.java V01L01 Copyright＠QINGDAO FUBO SYSTEM ENGINEERING CO.,LTD 2012                        */
/*--------------------------------------------------------------------------------------------------------------------*/
/*                                                                                                                    */
/*  项目名称 ：信智互联                                                                                               */
/*  画面ＩＤ ：XZHL1010                                                                                               */
 ...
 * 显示自店产品广告一览数据
 */
public class XZHL1010_Advertisement extends Activity {
    ...
    // 上下文
    private static XZHL1010_Advertisement context;

    // 自定义对话框
    private XZHL1010_MsgDialog dialog;

    // 适配器
    private XZHL1010_ItemsAdapter itemAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 加载页面布局文件
        setContentView(R.layout.xzhl1010_advertisement);
    ...
    private void setUpView() {
        ...
        // 适配器
        itemAdapter = new XZHL1010_ItemsAdapter(this, list);
    ...
    private void addListener() {
        ...
        ivBack.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Log开始
                LogUtil.logStart();
                XZHL1010_Advertisement.this.finish();
        ...
        ivSearch.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText etSearch = (EditText) findViewById(R.id.et_search_1010);
                ...
                new AsyGetDataTask(XZHL1010_Advertisement.context).execute(params);
        ...
        ivAdd.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(XZHL1010_Advertisement.this, XZHL1020_AdvertisementInput.class);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(XZHL1010_Advertisement.context, XZHL1040_AdverAllInfo.class);
                startActivity(intent);
        ...
        listView.setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, final View view, final int position, long id) {
                ...
                // 显示自定义的对话框
                dialog = new XZHL1010_MsgDialog(XZHL1010_Advertisement.context, R.style.mydialog, position, str);
    ...
    private void initView() {
        ...
        // 标题栏后退图标
        ivBack = (ImageView) findViewById(R.id.iv_back_1010);

        // 标题栏新增图标
        ivAdd = (ImageView) findViewById(R.id.iv_add_1010);

        // 搜索图标
        ivSearch = (ImageView) findViewById(R.id.iv_search_1010);

        // 禁止查询
        ivSearch.setClickable(false);

        // 数据列表
        listView = (ListView) findViewById(R.id.tv_adv_1010);

        // 数据加载进度
        pbBar = (ProgressBar) findViewById(R.id.pb_pblist_1010);
    ...
    private String[] dataList(View view) {
        ...
        TextView tvId = (TextView) view.findViewById(R.id.tv_id_1010);
        TextView tvName = (TextView) view.findViewById(R.id.tv_hdmc_1010);
        TextView tvBeginDate = (TextView) view.findViewById(R.id.tv_kssj_1010);
        TextView tvEndDate = (TextView) view.findViewById(R.id.tv_jssj_1010);
        TextView tvTarget = (TextView) view.findViewById(R.id.tv_hddx_1010);
        TextView tvProduct = (TextView) view.findViewById(R.id.tv_hdsp_1010);
        TextView tvMethod = (TextView) view.findViewById(R.id.tv_yhfs_1010);
        TextView tvSetting = (TextView) view.findViewById(R.id.tv_yhsz_1010);
        TextView tvAdv = (TextView) view.findViewById(R.id.tv_hdxy_1010);
    ...
    private void initData() {
        ...
        XZHL1010_Advertisement.context = this;
        list = new ArrayList<XZHL1010_Bean>();
     ...
     * 发送异步请求,获得数据库数据
     */
    class AsyGetDataTask extends AsyncTask<List<String>, String, List<XZHL1010_Bean>> {

        XZHL1010_Advertisement context;

        /**
         * 构造器
         */
        public AsyGetDataTask(XZHL1010_Advertisement context) {
         ...
         */
        @Override
        protected List<XZHL1010_Bean> doInBackground(List<String>... params) {
            ...
            // 调用接口请求数据
            String portName = CommonConst.PORTNAME1010;
            String data = JsonUtil.DataToJson(new String[] { CommonConst.SHOPID, CommonConst.EXERCISENAME },
                new String[] { params[0].get(0), params[0].get(1) });
            ...
            try {
                return XZHL1010_Util.jsonToList(result);
            } catch (Exception e) {

                // 异常log输出
                LogUtil.logException(e);
                return new ArrayList<XZHL1010_Bean>();
            } finally {
         ...
         */
        @Override
        protected void onPostExecute(List<XZHL1010_Bean> result) {
    ...
    class AsyDeleteTask extends AsyncTask<String, String, String> {
         ...
         * 构造器初始化数据
         */
        public AsyDeleteTask(XZHL1010_Advertisement context, int position) {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (result == null) {
                    ...
                    // 异常弹出提示信息
                    MessageUtil.commonToast(XZHL1010_Advertisement.context, MessageUtil.getMessage(context, Msg.E0002),
                        Toast.LENGTH_SHORT);
                    return;
                } else {
                    ...
                    if (CommonConst.ONE.equals(success)) {
                        ...
                        // 成功时弹出提示信息并更新条目更新条目
                        MessageUtil.commonToast(XZHL1010_Advertisement.context,
     ...
     */
    public void updateListView(List<XZHL1010_Bean> result) {
     ...
     * 修改和删除显示对话框
     */
    class XZHL1010_MsgDialog extends Dialog {
        ...
        // 上下文
        private XZHL1010_Advertisement context;

        /**
         * 自定义构造器初始化参数
         */
        public XZHL1010_MsgDialog(XZHL1010_Advertisement context, int theme, int position, String[] content) {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            // Log开始
            LogUtil.logStart();
            this.setContentView(R.layout.xzhl1010_dialogview);
        ...
        private void setupDialogView() {
            ...
            // Log开始
            LogUtil.logStart();
            tvMsg = (TextView) findViewById(R.id.tv_name_1010);
            tvMsg.setText(content[1]);
            tvChange = (TextView) findViewById(R.id.tv_change_1010);
            tvDelete = (TextView) findViewById(R.id.tv_delete_1010);
